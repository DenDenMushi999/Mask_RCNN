...
class CocoDataset(utils.Dataset):
    ...
    def load_coco(self, dataset_dir, subset, class_ids=None,
        ...
        # Changed this to my iwn dataset structure
        coco = COCO("{}/{}/_annotations.coco.json".format(dataset_dir, subset))
    ...
    def image_reference(self, image_id):
        ...
        if info["source"] == "coco":
            return "".format(info["path"])
        else:
            # This fiunction is not implemented in parent class and returns ""
